...
////////////////////////////////////////////////////|:|             OWNER DETAILS             |:|//////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
global.session = process.env.SESSION_ID || 'WWc0aXdERjE=',
global.ownername = process.env.OWNER_NAME === undefined ? "Anupa" : process.env.OWNER_NAME
let fake = process.env.OWNER_NUMBER === undefined ? '94775200935' : process.env.OWNER_NUMBER
global.owner = [`${Anupa}`]
global.ownernumber = [`${0752409059}`]
global.premium = [`${Anupa}`]
